...
(async () => {
  ...
  check('Coincide exactamente con el formato esperado (nombres numerados + monto, sin la ya pagada, + TOTAL DEL GASTO COMPLETO -- $7.000, no $6.500 -- + datos de transferencia)', contieneEsperado, whatsappTxt.texto);
