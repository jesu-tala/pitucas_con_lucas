...
""" + indent + """  metaAcumuladoActual: metaAcumuladoActual, annualInvestmentGoalProgress: annualInvestmentGoalProgress,
""" + indent + """  metaAportadoNeto: metaAportadoNeto, metaMonths: metaMonths, metaHistorialAt: metaHistorialAt,
""" + indent + """  metaContribTxs: metaContribTxs, metaContribAmount: metaContribAmount,
""" + indent + """  investmentCatOptions: investmentCatOptions, generalCatIdFor: generalCatIdFor,
""" + indent + """  goalsForPlatform: goalsForPlatform, goalCapablePlatformIds: goalCapablePlatformIds,
""" + indent + """  platformIds: platformIds, platformAportadoNeto: platformAportadoNeto,
""" + indent + """  platformAportadoNetoHastaMes: platformAportadoNetoHastaMes, valorTotalEnMesONull: valorTotalEnMesONull,
""" + indent + """  aportadoAcumuladoHastaMesONull: aportadoAcumuladoHastaMesONull,
...
""" + indent + """  receivableAssignedTotal: receivableAssignedTotal, receivableEstado: receivableEstado,
""" + indent + """  assignIncomeToReceivable: assignIncomeToReceivable, removeIncomeAssignment: removeIncomeAssignment,
""" + indent + """  incomeAssignedTotal: incomeAssignedTotal, receivablesLinkedFrom: receivablesLinkedFrom,
...
""" + indent + """  enableNotifications: enableNotifications, disableNotifications: disableNotifications,
""" + indent + """  useImportedStatement: useImportedStatement,
""" + indent + """  enterDemoMode: enterDemoMode, exitDemoMode: exitDemoMode, isDemoActive: isDemoActive,
""" + indent + """  preserveGroupTransactionsBeforeUnlink: preserveGroupTransactionsBeforeUnlink,
""" + indent + """  navPush: navPush, navPop: navPop, navPeek: navPeek, navDepth: navDepth,
""" + indent + """  navClear: navClear, navClearType: navClearType, navPopIfTop: navPopIfTop,
""" + indent + """  navStackSnapshot: navStackSnapshot, navigateBack: navigateBack,
...
""" + indent + """  setTransactions: setTransactions,
...
""" + indent + """  get inPasswordRecovery(){ return inPasswordRecovery; }, set inPasswordRecovery(v){ inPasswordRecovery = v; },
""" + indent + """  onAuthenticated: onAuthenticated, showAuthRecoveryForm: showAuthRecoveryForm,
""" + indent + """  handlePasswordRecoverySubmit: handlePasswordRecoverySubmit,
...
""" + indent + """  applyStateBlob: applyStateBlob, buildFullStateBlob: buildFullStateBlob, emptyAppStateBlob: emptyAppStateBlob,
""" + indent + """  nextImportId: nextImportId,
