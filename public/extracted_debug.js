  ...
  async function crearGrupo(nombre, icono) {
    ...
    if (error) {
      ...
      sb.auth.getUser().then(function(res) {
        ...
        const detalleServidor = quienSoy ? quienSoy.id : "sin sesi\xF3n (" + (res && res.error ? res.error.message : "sin detalle") + ")";
        toast("Diagn\xF3stico \u2014 app: " + currentUserId + " \xB7 servidor: " + detalleServidor);
      }).catch(function(err) {
        toast("Diagn\xF3stico fall\xF3: " + (err && err.message ? err.message : String(err)));
      });
