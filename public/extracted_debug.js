(() => {
  ...
  async function crearGrupo(nombre, icono) {
    ...
    if (insertRes.error) {
      ...
      toast("Diagn\xF3stico \u2014 fall\xF3 el INSERT: " + insertRes.error.message);
    ...
    if (error) {
      console.error("Pitucas sin lucas \u2014 el INSERT funcion\xF3 pero el select-back fall\xF3:", error);
      toast("Diagn\xF3stico \u2014 el INSERT funcion\xF3, fall\xF3 el SELECT de vuelta: " + error.message);
