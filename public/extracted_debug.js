(() => {
  ...
  function investmentCatOptions(selectedId) {
    ...
    platformIds().forEach((platId) => {
      ...
      out.push({ value: generalId, label: plat.nombre + " \xB7 General", plataformaId: platId, icon: plat.icon });
    });
    return out;
  }
  ...
  function renderPlatformGroup(id) {
    ...
    const metasBody = combinedSummary + metas.map(renderGoalCard).join("") + (addingHere ? renderGoalEditForm(null, id) : '<button class="budget-add-link platform-add-meta-link" data-add-goal="' + id + '">+ Agregar meta a ' + cat.nombre + "</button>");
    ...
    (!tieneMetas ? '<div class="platform-diff-row">' + termChip(PLATFORM_DATA[id].plazo) + "</div>" : "") + comisionRow + '<div class="platform-actions-row"><button class="budget-ver-mas" data-platform-see-more="' + id + '">Ver transacciones \u2192</button><button class="budget-edit-btn" data-edit-platform="' + id + '" aria-label="Actualizar valor de ' + cat.nombre + '">' + ICONS.edit + '</button></div><div class="platform-goal-nest">' + metasBody + "</div></div>";
  ...
  __name(totalGoalProgress, "totalGoalProgress");
  ...
  phone.addEventListener("click", function(e) {
    ...
    if (editGoalBtn) {
      ...
      state.goalDraft = meta ? { nombre: meta.nombre, montoObjetivo: String(meta.montoObjetivo), aporteMensualMeta: String(meta.aporteMensualMeta), aportadoInicial: String(meta.startingAmount || 0), mesInicio: meta.startMonth || todayISO().slice(0, 7), plazo: meta.plazo || "", comision: meta.comision != null ? String(meta.comision) : "" } : { nombre: "", montoObjetivo: "", aporteMensualMeta: "", aportadoInicial: "", mesInicio: todayISO().slice(0, 7), plazo: "", comision: "" };
      renderInvestmentsView();
      return;
    }
  ...
  window.__debug = {
    ...
    metaAcumuladoActual: metaAcumuladoActual, totalGoalProgress: totalGoalProgress,
    ...
    goalsForPlatform: goalsForPlatform,
