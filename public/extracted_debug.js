    ...
    if (receiptCaptureBtn && state.boleta) {
      ...
      setTimeout(function() {
        ...
        state.boleta.items = ejemplo.items.map(function(it) {
          return { id: nextReceiptItemId(), nombre: it.nombre, monto: it.monto };
        });
