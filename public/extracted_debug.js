(() => {
  ...
  function catInfo(id) {
    return CATEGORIES[id] || { nombre: "Sin categor\xEDa", color: "neutral", icon: "more", tipo: "gasto" };
  }
  ...
  phone.addEventListener("click", function(e) {
    ...
    if (editGoalBtn) {
      ...
      state.goalDraft = meta ? { nombre: meta.nombre, montoObjetivo: String(meta.montoObjetivo), aporteMensualMeta: String(meta.aporteMensualMeta), plazo: meta.plazo || "", comision: meta.comision != null ? String(meta.comision) : "" } : { nombre: "", montoObjetivo: "", aporteMensualMeta: "", plazo: "", comision: "" };
      renderInvestmentsView();
      return;
    }
  ...
  function renderFilterSheetContent() {
    const af = state.advFilters;
    const catChips = '<div class="cat-picker-grid">' + chipToggle("toggle-filter-cat", "__sin_cat__", "Sin categor\xEDa", null, af.cats.includes("__sin_cat__")) + Object.keys(CATEGORIES).map((k) => chipToggle("toggle-filter-cat", k, CATEGORIES[k].nombre, CATEGORIES[k].icon, af.cats.includes(k))).join("") + "</div>";
